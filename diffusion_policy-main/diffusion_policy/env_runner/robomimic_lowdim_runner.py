...
class RobomimicLowdimRunner(BaseLowdimRunner):
    ...
    def __init__(self, 
        ...
        full_path = os.path.join("./diffusion_policy/", dataset_path)
        print(full_path)
        dataset_path = os.path.expanduser(full_path)
    ...
    def run(self, policy: BaseLowdimPolicy):
        ...
        # env_sim = EnvUtils.create_env_from_metadata(
        ...
        for chunk_idx in range(n_chunks):
            ...
            while not done:
                ...
                obs, reward, done, info = env_sim.step(env_action)
                sim.step()
                viewer.render()
