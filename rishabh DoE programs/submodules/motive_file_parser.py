...
def extract_data(file_path: str):
    ...
    CXYZ = rb_TxyzQwxyz["chisel"][:, 0:3]
    Cwxyz = rb_TxyzQwxyz["chisel"][:, 3:]
    GXYZ = rb_TxyzQwxyz["gripper"][:, 0:3]
    Gwxyz = rb_TxyzQwxyz["gripper"][:, 3:]
    BXYZ = rb_TxyzQwxyz["battery"][:, 0:3]
    Bwxyz = rb_TxyzQwxyz["battery"][:, 3:]
    A1XYZ = mk_TxyzQwxyz["A1"]
    A2XYZ = mk_TxyzQwxyz["A2"]
    A3XYZ = mk_TxyzQwxyz["A3"]
    B1XYZ = mk_TxyzQwxyz["B1"]
    B2XYZ = mk_TxyzQwxyz["B2"]
    B3XYZ = mk_TxyzQwxyz["B3"]
    C1XYZ = mk_TxyzQwxyz["C1"]
    C2XYZ = mk_TxyzQwxyz["C2"]
    C3XYZ = mk_TxyzQwxyz["C3"]
